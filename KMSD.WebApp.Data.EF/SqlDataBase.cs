...
using KMSD.WebApp.Data.EF.Extensions;
...
namespace KMSD.WebApp.Data.EF
{
    ...
    public class SqlDataBase : IDatabase
    {
        ...
        ///// 构造方法
        ///// </summary>
        public SqlDataBase(string connString, string DbType)
        {
            if (DbType == "")
            {
                ...
                //if (dbcontext == null)
                //{
                //    dbcontext = (DbContext)AutofacContainerManager.Instance.Resolve<IDbContext>(new NamedParameter[] { new NamedParameter("connString", connString) });
            ...
            {
                //dbcontext = (DbContext)CallContext.GetData("dbTypeContext");
                //if (dbcontext == null)
                //{
                //    dbcontext = (DbContext)AutofacContainerManager.Instance.Resolve<IDbContext>(DbType, new NamedParameter("connString", connString));

                //    CallContext.SetData("dbTypeContext", dbcontext);
                //}
